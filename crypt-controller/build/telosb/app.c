...
typedef nx_struct cack {
  nx_uint8_t accept;
} __attribute__((packed)) ConnectACKMsg;
...
typedef nx_struct response {
  nx_uint8_t data[32];
} __attribute__((packed)) ResponseMsg;
...
typedef nx_struct serial_query_response {
  ...
  nx_uint8_t name[16];
  nx_uint8_t src;
} __attribute__((packed)) SerialQueryResponseMsg;
...
typedef nx_struct serial_response {
  nx_uint16_t data;
  nx_uint8_t src;
} __attribute__((packed)) SerialResponseMsg;
...
typedef nx_struct serial_connect {
  nx_uint8_t addr;
  nx_uint8_t rate;
} __attribute__((packed)) SerialConnect;
...
typedef nx_struct serial_cack {
  nx_uint8_t accept;
  nx_uint8_t src;
} __attribute__((packed)) SerialConnectACKMsg;
# 49 "../lib/ChannelState.h"
#line 37
...
enum __nesc_unnamed4259 {
  ...
  MAC_PACKET_SIZE = MAC_HEADER_SIZE + 40 + MAC_FOOTER_SIZE, 
...
struct skipjack_key_st {
  ...
  unsigned char ekey[38];
};



typedef struct skipjack_key_st SKIPJACK_KEY;
typedef TMilli ControllerC__CleanerTimer__precision_tag;
...
typedef TMilli LEDBlinkP__LEDTimer1__precision_tag;
typedef TMilli LEDBlinkP__LEDTimer2__precision_tag;
typedef TMilli LEDBlinkP__LEDTimer0__precision_tag;
...
# 48 "../lib/KNoTCrypt.nc"
static message_t *ControllerC__KNoT__receive(uint8_t src, message_t *msg, void *payload, uint8_t len);
...
static void ControllerC__SerialSend__sendDone(
#line 103
message_t * msg, 
...
static void ControllerC__CleanerTimer__fired(void );
...
ControllerC__SerialReceive__receive(
#line 71
message_t * msg, 
void * payload, 
...
# 83 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
static void LEDBlinkP__LEDTimer1__fired(void );
# 3 "../lib/LEDBlink.nc"
static void LEDBlinkP__LEDBlink__report_sent(void );
#line 2
static void LEDBlinkP__LEDBlink__report_problem(void );

static void LEDBlinkP__LEDBlink__report_received(void );
# 83 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
static void LEDBlinkP__LEDTimer2__fired(void );
#line 83
static void LEDBlinkP__LEDTimer0__fired(void );
# 43 "../lib/KNoTCrypt.nc"
static void KNoTCryptP__KNoT__close_graceful(ChanState *state);


static void KNoTCryptP__KNoT__disconnect_handler(ChanState *state, DataPayload *dp);
#line 30
static void KNoTCryptP__KNoT__send_rack(ChanState *state);
...
static void KNoTCryptP__KNoT__pack_handler(ChanState *state, DataPayload *dp);
#line 22
static uint8_t KNoTCryptP__KNoT__controller_cack_handler(ChanState *state, DataPayload *dp);
#line 4
static int KNoTCryptP__KNoT__valid_seqno(ChanState *state, DataPayload *dp);


static void KNoTCryptP__KNoT__send_on_chan(ChanState *state, DataPayload *dp);
...
static void KNoTCryptP__KNoT__connect(ChanState *new_state, uint8_t addr, int rate);
#line 10
static void KNoTCryptP__KNoT__knot_broadcast(ChanState *state, DataPayload *dp);
#line 28
static void KNoTCryptP__KNoT__response_handler(ChanState *state, DataPayload *dp);
#line 12
static void KNoTCryptP__KNoT__query(ChanState *state, uint8_t type);
#line 37
static void KNoTCryptP__KNoT__ping_handler(ChanState *state, DataPayload *dp);
#line 34
static void KNoTCryptP__KNoT__ping(ChanState *state);
#line 16
static void KNoTCryptP__KNoT__qack_handler(ChanState *state, DataPayload *dp, uint8_t src);
# 60 "/home/user/tinyos-main/tos/interfaces/Boot.nc"
static void KNoTCryptP__Boot__booted(void );
# 110 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
static void KNoTCryptP__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 113 "/home/user/tinyos-main/tos/interfaces/SplitControl.nc"
static void KNoTCryptP__RadioControl__startDone(error_t error);
#line 138
static void KNoTCryptP__RadioControl__stopDone(error_t error);
# 78 "/home/user/tinyos-main/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 70 "../lib/OCBMode.nc"
static error_t OCBModeP__OCBMode__init(CipherModeContext *context, 
uint8_t keySize, uint8_t *key, 
uint8_t tagLength, uint8_t preCombBlocks);
# 2 "../lib/BlockCipher.nc"
static error_t SkipJackM__BlockCipher__init(CipherContext *context, uint8_t blockSize, 
uint8_t keySize, uint8_t *key);
static error_t SkipJackM__BlockCipher__encrypt(CipherContext *context, 
uint8_t *plainBlock, 
uint8_t *cipherBlock);
# 80 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
static error_t /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
/*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__getPayload(
#line 132
message_t * msg, 
...
uint8_t len);
# 100 "/home/user/tinyos-main/tos/interfaces/Send.nc"
static void /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 96
message_t * msg, 
...
# 6 "../lib/ChannelTable.nc"
static void ChannelTableC__ChannelTable__init_table(void );
#line 18
static ChanState *ChannelTableC__ChannelTable__get_channel_state(int channel);





static void ChannelTableC__ChannelTable__remove_channel(int channel);
#line 12
static ChanState *ChannelTableC__ChannelTable__new_channel(void );
# 2 "../lib/ChannelState.nc"
static void ChannelStateC__ChannelState__init_state(ChanState *state, uint8_t chan_num);
# 80 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
...
# 73 "/home/user/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 71
...
# 100 "/home/user/tinyos-main/tos/interfaces/Send.nc"
static void /*ControllerAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 43 "../lib/KNoTCrypt.nc"
static void ControllerC__KNoT__close_graceful(ChanState *state);


static void ControllerC__KNoT__disconnect_handler(ChanState *state, DataPayload *dp);
#line 30
static void ControllerC__KNoT__send_rack(ChanState *state);
...
static void ControllerC__KNoT__pack_handler(ChanState *state, DataPayload *dp);
#line 22
static uint8_t ControllerC__KNoT__controller_cack_handler(ChanState *state, DataPayload *dp);
#line 4
static int ControllerC__KNoT__valid_seqno(ChanState *state, DataPayload *dp);


static void ControllerC__KNoT__send_on_chan(ChanState *state, DataPayload *dp);
...
static void ControllerC__KNoT__connect(ChanState *new_state, uint8_t addr, int rate);
...
static void ControllerC__KNoT__response_handler(ChanState *state, DataPayload *dp);
#line 12
static void ControllerC__KNoT__query(ChanState *state, uint8_t type);
#line 37
static void ControllerC__KNoT__ping_handler(ChanState *state, DataPayload *dp);
#line 34
static void ControllerC__KNoT__ping(ChanState *state);
#line 16
static void ControllerC__KNoT__qack_handler(ChanState *state, DataPayload *dp, uint8_t src);
# 64 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
static void ControllerC__CleanerTimer__startPeriodic(uint32_t dt);
# 3 "../lib/LEDBlink.nc"
static void ControllerC__LEDBlink__report_sent(void );
#line 2
static void ControllerC__LEDBlink__report_problem(void );

static void ControllerC__LEDBlink__report_received(void );
# 6 "../lib/ChannelTable.nc"
static void ControllerC__ChannelTable__init_table(void );
#line 18
static ChanState *ControllerC__ChannelTable__get_channel_state(int channel);





static void ControllerC__ChannelTable__remove_channel(int channel);
#line 12
static ChanState *ControllerC__ChannelTable__new_channel(void );
# 2 "../lib/ChannelState.nc"
static void ControllerC__ChannelState__init_state(ChanState *state, uint8_t chan_num);
# 39 "ControllerC.nc"
ChanState ControllerC__home_chan;
bool ControllerC__serialSendBusy = FALSE;


static inline void ControllerC__check_timer(ChanState *state);
#line 63
static inline void ControllerC__cleaner(void );
#line 77
...
static inline message_t *ControllerC__KNoT__receive(uint8_t src, message_t *msg, void *payload, uint8_t len);
#line 136
static inline message_t *ControllerC__SerialReceive__receive(message_t *msg, void *payload, uint8_t len);
#line 158
static void ControllerC__SerialSend__sendDone(message_t *msg, error_t error);
...
static inline void ControllerC__CleanerTimer__fired(void );
# 62 "/home/user/tinyos-main/tos/interfaces/Init.nc"
...
enum /*CounterMilli32C.Transform*/TransformCounterC__1____nesc_unnamed4364 {
...
enum /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC__1____nesc_unnamed4365 {
...
message_t *msg);
# 73 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
static void LEDBlinkP__LEDTimer1__startOneShot(uint32_t dt);
#line 73
static void LEDBlinkP__LEDTimer2__startOneShot(uint32_t dt);
# 67 "/home/user/tinyos-main/tos/interfaces/Leds.nc"
static void LEDBlinkP__Leds__led0Toggle(void );
#line 83
static void LEDBlinkP__Leds__led1Toggle(void );
#line 100
static void LEDBlinkP__Leds__led2Toggle(void );
# 73 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
static void LEDBlinkP__LEDTimer0__startOneShot(uint32_t dt);
# 11 "../lib/LEDBlinkP.nc"
static inline void LEDBlinkP__pulse_red_led(int t);




static inline void LEDBlinkP__pulse_blue_led(int t);




static inline void LEDBlinkP__pulse_green_led(int t);
...
static void LEDBlinkP__LEDBlink__report_problem(void );
static inline void LEDBlinkP__LEDBlink__report_sent(void );
static void LEDBlinkP__LEDBlink__report_received(void );




static inline void LEDBlinkP__LEDTimer0__fired(void );



static inline void LEDBlinkP__LEDTimer1__fired(void );




static inline void LEDBlinkP__LEDTimer2__fired(void );
# 48 "../lib/KNoTCrypt.nc"
static message_t *KNoTCryptP__KNoT__receive(uint8_t src, message_t *msg, void *payload, uint8_t len);
# 80 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
static error_t KNoTCryptP__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
KNoTCryptP__AMSend__getPayload(
#line 132
message_t * msg, 
...
uint8_t len);
# 104 "/home/user/tinyos-main/tos/interfaces/SplitControl.nc"
static error_t KNoTCryptP__RadioControl__start(void );
# 70 "../lib/OCBMode.nc"
static error_t KNoTCryptP__CipherMode__init(CipherModeContext *context, 
uint8_t keySize, uint8_t *key, 
uint8_t tagLength, uint8_t preCombBlocks);
# 3 "../lib/LEDBlink.nc"
static void KNoTCryptP__LEDBlink__report_sent(void );
#line 2
static void KNoTCryptP__LEDBlink__report_problem(void );
# 88 "/home/user/tinyos-main/tos/interfaces/AMPacket.nc"
static am_addr_t KNoTCryptP__AMPacket__source(
#line 84
message_t * amsg);
#line 68
static am_addr_t KNoTCryptP__AMPacket__address(void );
# 40 "../lib/KNoTCryptP.nc"
message_t KNoTCryptP__am_pkt;


bool KNoTCryptP__sendBusy = FALSE;



uint8_t KNoTCryptP__keySize = 10;
uint8_t KNoTCryptP__preCombBlocks = 5;
uint8_t KNoTCryptP__tagLength = 4;
CipherModeContext KNoTCryptP__cc;
uint8_t KNoTCryptP__key[];
#line 73
static void KNoTCryptP__increment_seq_no(ChanState *state, DataPayload *dp);
...
static void KNoTCryptP__send(int dest, DataPayload *dp);
#line 117
static void KNoTCryptP__dp_complete(DataPayload *dp, uint8_t src, uint8_t dst, 
...
static inline int KNoTCryptP__KNoT__valid_seqno(ChanState *state, DataPayload *dp);
#line 137
static inline void KNoTCryptP__KNoT__send_on_chan(ChanState *state, DataPayload *dp);




static inline void KNoTCryptP__KNoT__knot_broadcast(ChanState *state, DataPayload *dp);
...
static inline void KNoTCryptP__KNoT__query(ChanState *state, uint8_t type);
#line 187
static inline void KNoTCryptP__KNoT__qack_handler(ChanState *state, DataPayload *dp, uint8_t src);
#line 201
static inline void KNoTCryptP__KNoT__connect(ChanState *state, uint8_t addr, int rate);
#line 248
static inline uint8_t KNoTCryptP__KNoT__controller_cack_handler(ChanState *state, DataPayload *dp);
#line 317
static void KNoTCryptP__KNoT__response_handler(ChanState *state, DataPayload *dp);
#line 336
static inline void KNoTCryptP__KNoT__send_rack(ChanState *state);
#line 354
static inline void KNoTCryptP__KNoT__ping(ChanState *state);
...
static inline void KNoTCryptP__KNoT__ping_handler(ChanState *state, DataPayload *dp);
#line 376
static inline void KNoTCryptP__KNoT__pack_handler(ChanState *state, DataPayload *dp);
...
static inline void KNoTCryptP__KNoT__disconnect_handler(ChanState *state, DataPayload *dp);
...
static inline void KNoTCryptP__Boot__booted(void );
...
static inline void KNoTCryptP__RadioControl__startDone(error_t error);
...
static inline void KNoTCryptP__RadioControl__stopDone(error_t error);

static inline message_t *KNoTCryptP__Receive__receive(message_t *msg, void *payload, uint8_t len);



static void KNoTCryptP__AMSend__sendDone(message_t *msg, error_t error);
# 2 "../lib/BlockCipher.nc"
static error_t OCBModeP__cipher__init(CipherContext *context, uint8_t blockSize, 
uint8_t keySize, uint8_t *key);
static error_t OCBModeP__cipher__encrypt(CipherContext *context, 
uint8_t *plainBlock, 
uint8_t *cipherBlock);
# 40 "../lib/OCBModeP.nc"
typedef uint8_t OCBModeP__block[8];
OCBModeP__block OCBModeP__L[7 + 1];
OCBModeP__block OCBModeP__L_inv;
uint8_t OCBModeP__preCombBlks;



static inline void OCBModeP__shift_left(uint8_t *x);
static inline void OCBModeP__shift_right(uint8_t *x);

static void OCBModeP__cpy_blk(uint8_t *des, uint8_t *src, uint8_t block_size);




static inline void OCBModeP__dumpBuffer(char *bufName, uint8_t *buf, uint8_t size);


static inline error_t OCBModeP__OCBMode__init(CipherModeContext *context, 
uint8_t keySize, 
uint8_t *key, 
uint8_t tagLength, 
...
#line 359
static inline void OCBModeP__dumpBuffer(char *bufName, uint8_t *buf, uint8_t size);
# 134 "../lib/SkipJackM.nc"
const uint8_t SkipJackM__F[256] = 
{ 
...
#line 186
static inline error_t SkipJackM__BlockCipher__init(CipherContext *context, uint8_t 
...
uint8_t *cipherBlock);
# 110 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
static void /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/home/user/tinyos-main/tos/interfaces/Send.nc"
static error_t /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 67
message_t * msg, 
...
/*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__getPayload(
#line 122
message_t * msg, 
...
static void /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 158
message_t * amsg, 
...
static inline error_t /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
...
static inline void */*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__getPayload(message_t *m, uint8_t len);
# 80 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
...
# 12 "../lib/ChannelTableC.nc"
static Channel ChannelTableC__channelTable[5];
static Channel *ChannelTableC__nextFree;

static Channel *ChannelTableC__iterStart;
uint8_t ChannelTableC__size;

static void ChannelTableC__init_state(ChanState *state, uint8_t chan_num);
...
static inline void ChannelTableC__ChannelTable__init_table(void );
#line 43
static inline ChanState *ChannelTableC__ChannelTable__new_channel(void );
#line 61
static ChanState *ChannelTableC__ChannelTable__get_channel_state(int channel);
...
static void ChannelTableC__ChannelTable__remove_channel(int channel);
# 10 "../lib/ChannelStateC.nc"
static inline void ChannelStateC__ChannelState__init_state(ChanState *state, uint8_t chan_num);
# 110 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
...
# 48 "/home/user/tinyos-main/tos/system/QueueC.nc"
...
# 90 "/home/user/tinyos-main/tos/interfaces/Queue.nc"
...
# 114 "/home/user/tinyos-main/tos/lib/printf/PrintfP.nc"
...
# 110 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
static void /*ControllerAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(
#line 103
message_t * msg, 
...
static inline void /*ControllerAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(message_t *m, error_t err);
...
# 39 "/home/user/tinyos-main/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x40715b30){
#line 39
  switch (arg_0x40715b30) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x40715b30);
#line 39
      break;
#line 39
    }
...
# 88 "/home/user/tinyos-main/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x412d6148, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x412d6148, msg);
#line 88
}
#line 88
...
# 128 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40ea6940){
#line 128
  unsigned char __nesc_result;
#line 128

#line 128
  switch (arg_0x40ea6940) {
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40ea6940);
#line 128
      break;
#line 128
    }
...
# 39 "/home/user/tinyos-main/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40ea5418){
#line 39
  union __nesc_unnamed4278 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40ea5418);
#line 39
...
# 59 "/home/user/tinyos-main/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x40b7dcf8){
#line 59
  switch (arg_0x40b7dcf8) {
#line 59
...
#line 59
    default:
#line 59
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x40b7dcf8);
#line 59
      break;
#line 59
    }
...
# 61 "/home/user/tinyos-main/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x40b58948){
#line 61
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x40b58948);
#line 61
}
#line 61
...
# 97 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40ea6940){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40ea6940);
#line 97
      break;
#line 97
    }
...
# 53 "/home/user/tinyos-main/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__requested(uint8_t arg_0x40b58948){
#line 53
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__requested(arg_0x40b58948);
#line 53
}
#line 53
...
# 88 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40ea6940){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40ea6940);
#line 88
      break;
#line 88
    }
...
# 65 "/home/user/tinyos-main/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x40b7dcf8){
#line 65
  switch (arg_0x40b7dcf8) {
#line 65
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x40b7dcf8);
#line 65
      break;
#line 65
    }
...
# 120 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40ea6940){
#line 120
  unsigned char __nesc_result;
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40ea6940);
#line 120
      break;
#line 120
    }
...
#line 162
# 80 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x41449490, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x41449490, addr, msg, len);
#line 80
...
# 23 "/home/user/tinyos-main/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x4088a688, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x4088a688) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x4088a688, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x4088a688){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x4088a688);
#line 15
      break;
#line 15
    }
...
# 110 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static void /*ControllerAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  ControllerC__SerialSend__sendDone(msg, error);
#line 110
}
#line 110
# 65 "/home/user/tinyos-main/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*ControllerAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(m, err);
}
...
# 100 "/home/user/tinyos-main/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x4144a9d8, message_t * msg, error_t error){
#line 100
  switch (arg_0x4144a9d8) {
#line 100
    case 0U:
#line 100
...
#line 100
    case 1U:
#line 100
      /*ControllerAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x4144a9d8, msg, error);
#line 100
      break;
#line 100
    }
...
# 73 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void LEDBlinkP__LEDTimer1__startOneShot(uint32_t dt){
#line 73
...
inline static void LEDBlinkP__Leds__led1Toggle(void ){
#line 83
...
#line 21
{
  LEDBlinkP__Leds__led1Toggle();
  LEDBlinkP__LEDTimer1__startOneShot(t);
}
...
{
#line 33
  LEDBlinkP__pulse_green_led(100);
}

# 3 "../lib/LEDBlink.nc"
inline static void ControllerC__LEDBlink__report_sent(void ){
#line 3
  LEDBlinkP__LEDBlink__report_sent();
#line 3
}
#line 3
# 67 "/home/user/tinyos-main/tos/interfaces/TaskBasic.nc"
...
# 67 "/home/user/tinyos-main/tos/interfaces/Leds.nc"
inline static void LEDBlinkP__Leds__led0Toggle(void ){
#line 67
...
#line 11
{
  LEDBlinkP__Leds__led0Toggle();
  LEDBlinkP__LEDTimer0__startOneShot(t);
}

# 73 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void LEDBlinkP__LEDTimer2__startOneShot(uint32_t dt){
#line 73
...
inline static void LEDBlinkP__Leds__led2Toggle(void ){
#line 100
...
#line 16
{
  LEDBlinkP__Leds__led2Toggle();
  LEDBlinkP__LEDTimer2__startOneShot(t);
}
...
#line 126
# 69 "/home/user/tinyos-main/tos/system/QueueC.nc"
static inline void /*PrintfC.QueueC*/QueueC__0__printQueue(void )
#line 69
{
}
...
# 81 "/home/user/tinyos-main/tos/interfaces/Queue.nc"
...
#line 67
# 122 "/home/user/tinyos-main/tos/lib/serial/SerialActiveMessageP.nc"
static inline uint8_t /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Packet__payloadLength(message_t *msg)
#line 122
{
...
# 110 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static void /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  KNoTCryptP__AMSend__sendDone(msg, error);
#line 110
}
#line 110
# 65 "/home/user/tinyos-main/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 100 "/home/user/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x4144a9d8, message_t * msg, error_t error){
#line 100
  switch (arg_0x4144a9d8) {
#line 100
    case 0U:
#line 100
      /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x4144a9d8, msg, error);
#line 100
      break;
#line 100
    }
...
# 3 "../lib/LEDBlink.nc"
inline static void KNoTCryptP__LEDBlink__report_sent(void ){
#line 3
  LEDBlinkP__LEDBlink__report_sent();
#line 3
}
#line 3
#line 2
inline static void KNoTCryptP__LEDBlink__report_problem(void ){
#line 2
  LEDBlinkP__LEDBlink__report_problem();
#line 2
}
#line 2
# 169 "/home/user/tinyos-main/tos/system/AMQueueImplP.nc"
...
#line 67
# 80 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x41449490, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x41449490, addr, msg, len);
#line 80
...
# 59 "/home/user/tinyos-main/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x412d7a98, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x412d7a98, dest, msg);
#line 59
}
#line 59
# 75 "/home/user/tinyos-main/tos/interfaces/Send.nc"
...
# 95 "/home/user/tinyos-main/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x412d6148, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x412d6148, msg);
#line 95
}
#line 95
...
# 102 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x41262628){
#line 102
  switch (arg_0x41262628) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x41262628);
#line 102
      break;
#line 102
    }
...
# 24 "../lib/ChannelTable.nc"
inline static void ControllerC__ChannelTable__remove_channel(int channel){
#line 24
  ChannelTableC__ChannelTable__remove_channel(channel);
#line 24
}
#line 24
# 43 "../lib/KNoTCrypt.nc"
inline static void ControllerC__KNoT__close_graceful(ChanState *state){
#line 43
  KNoTCryptP__KNoT__close_graceful(state);
#line 43
}
#line 43
# 137 "../lib/KNoTCryptP.nc"
static inline void KNoTCryptP__KNoT__send_on_chan(ChanState *state, DataPayload *dp)
#line 137
{
  KNoTCryptP__increment_seq_no(state, dp);
  KNoTCryptP__send(state->remote_addr, dp);
}
...
#line 356
  ...
  KNoTCryptP__dp_complete(new_dp, state->chan_num, state->remote_chan_num, 
  11, 0);
  KNoTCryptP__KNoT__send_on_chan(state, new_dp);
  state->state = 7;
}

# 34 "../lib/KNoTCrypt.nc"
inline static void ControllerC__KNoT__ping(ChanState *state){
#line 34
  KNoTCryptP__KNoT__ping(state);
#line 34
}
#line 34
#line 7
inline static void ControllerC__KNoT__send_on_chan(ChanState *state, DataPayload *dp){
#line 7
  KNoTCryptP__KNoT__send_on_chan(state, dp);
#line 7
}
#line 7
# 43 "ControllerC.nc"
...
#line 46
  if (state->attempts_left > 0) {
      if (state->state % 2 != 0) {
        ControllerC__KNoT__send_on_chan(state, & state->packet);
        }
      else {
#line 50
        ControllerC__KNoT__ping(state);
        }
#line 51
      do {
#line 51
          state->ticks = state->ticks * 2;
#line 51
          state->ticks_left = state->ticks * 2;
        }
      while (
#line 51
      0);
...
#line 55
    {
      ...
      ControllerC__KNoT__close_graceful(state);
      ControllerC__ChannelTable__remove_channel(state->chan_num);
    }
}

# 18 "../lib/ChannelTable.nc"
inline static ChanState *ControllerC__ChannelTable__get_channel_state(int channel){
#line 18
  struct channel_state *__nesc_result;
#line 18

#line 18
  __nesc_result = ChannelTableC__ChannelTable__get_channel_state(channel);
#line 18
...
#line 66
  for (; i < 5; i++) {
      state = ControllerC__ChannelTable__get_channel_state(i);
      if (state) {
#line 68
        ControllerC__check_timer(state);
        }
    }
}
...
# 83 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x411c0678){
#line 83
  switch (arg_0x411c0678) {
#line 83
    case 1U:
#line 83
      LEDBlinkP__LEDTimer0__fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      LEDBlinkP__LEDTimer1__fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      LEDBlinkP__LEDTimer2__fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      ControllerC__CleanerTimer__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x411c0678);
#line 83
      break;
#line 83
    }
...
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__getPayload(am_id_t arg_0x41449490, message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135

#line 135
  __nesc_result = CC2420ActiveMessageP__AMSend__getPayload(arg_0x41449490, msg, len);
#line 135
...
# 125 "/home/user/tinyos-main/tos/interfaces/Send.nc"
inline static void * /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__getPayload(message_t * msg, uint8_t len){
#line 125
  void *__nesc_result;
#line 125
...
#line 73
{
  return /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__getPayload(m, len);
}

# 135 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static void * KNoTCryptP__AMSend__getPayload(message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135

#line 135
  __nesc_result = /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__getPayload(msg, len);
#line 135
...
# 75 "/home/user/tinyos-main/tos/interfaces/Send.nc"
inline static error_t /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
# 162 "/home/user/tinyos-main/tos/interfaces/AMPacket.nc"
inline static void /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/home/user/tinyos-main/tos/interfaces/AMPacket.nc"
inline static void /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 10);
  return /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}

# 80 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t KNoTCryptP__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*KNoTCryptC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 80
...
#line 80
# 50 "/home/user/tinyos-main/tos/interfaces/Queue.nc"
...
# 78 "/home/user/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x412d8088, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x412d8088, msg, payload, len);
#line 78
...
# 88 "/home/user/tinyos-main/tos/interfaces/AMPacket.nc"
inline static am_addr_t KNoTCryptP__AMPacket__source(message_t * amsg){
#line 88
  unsigned int __nesc_result;
#line 88
...
#line 88
# 4 "../lib/LEDBlink.nc"
inline static void ControllerC__LEDBlink__report_received(void ){
#line 4
  LEDBlinkP__LEDBlink__report_received();
#line 4
}
#line 4
# 395 "../lib/KNoTCryptP.nc"
static inline void KNoTCryptP__KNoT__disconnect_handler(ChanState *state, DataPayload *dp)
#line 395
{
  DataPayload *new_dp = & state->packet;
...
#line 397
  memset(new_dp, '\0', sizeof(DataPayload ));
  KNoTCryptP__dp_complete(new_dp, __nesc_ntoh_uint8(dp->hdr.src_chan_num.nxdata), state->remote_chan_num, 
  8, 0);
  KNoTCryptP__KNoT__send_on_chan(state, new_dp);
}

# 46 "../lib/KNoTCrypt.nc"
inline static void ControllerC__KNoT__disconnect_handler(ChanState *state, DataPayload *dp){
#line 46
  KNoTCryptP__KNoT__disconnect_handler(state, dp);
#line 46
}
#line 46
# 376 "../lib/KNoTCryptP.nc"
static inline void KNoTCryptP__KNoT__pack_handler(ChanState *state, DataPayload *dp)
#line 376
{
  if (state->state != 7) {
  ...
  do {
#line 382
      state->ticks = 3000 * state->rate / 100;
#line 382
      state->ticks_left = 3000 * state->rate / 100;
    }
  while (
#line 382
  0);
...
# 40 "../lib/KNoTCrypt.nc"
inline static void ControllerC__KNoT__pack_handler(ChanState *state, DataPayload *dp){
#line 40
  KNoTCryptP__KNoT__pack_handler(state, dp);
#line 40
}
#line 40
# 363 "../lib/KNoTCryptP.nc"
static inline void KNoTCryptP__KNoT__ping_handler(ChanState *state, DataPayload *dp)
#line 363
{
  DataPayload *new_dp;
...
# 37 "../lib/KNoTCrypt.nc"
inline static void ControllerC__KNoT__ping_handler(ChanState *state, DataPayload *dp){
#line 37
  KNoTCryptP__KNoT__ping_handler(state, dp);
#line 37
}
#line 37
# 336 "../lib/KNoTCryptP.nc"
static inline void KNoTCryptP__KNoT__send_rack(ChanState *state)
#line 336
{
  DataPayload *new_dp = & state->packet;
...
# 30 "../lib/KNoTCrypt.nc"
inline static void ControllerC__KNoT__send_rack(ChanState *state){
#line 30
  KNoTCryptP__KNoT__send_rack(state);
#line 30
}
#line 30
#line 28
inline static void ControllerC__KNoT__response_handler(ChanState *state, DataPayload *dp){
#line 28
  KNoTCryptP__KNoT__response_handler(state, dp);
#line 28
}
#line 28
# 248 "../lib/KNoTCryptP.nc"
static inline uint8_t KNoTCryptP__KNoT__controller_cack_handler(ChanState *state, DataPayload *dp)
#line 248
{
...
#line 252
  ...
  if (__nesc_ntoh_uint8(ck->accept.nxdata) == 0) {
      printf("KNOT>> SCREAM! THEY DIDN'T EXCEPT!!\n");
      return 0;
    }
  printf("KNOT>> %d accepts connection request on channel %d\n", state->remote_addr, __nesc_ntoh_uint8(dp->hdr.src_chan_num.nxdata));
#line 260
  printfflush();


  state->remote_chan_num = __nesc_ntoh_uint8(dp->hdr.src_chan_num.nxdata);
  new_dp = & state->packet;
  memset(new_dp, '\0', sizeof(DataPayload ));
  KNoTCryptP__dp_complete(new_dp, state->chan_num, state->remote_chan_num, 
  4, 0);
...
# 22 "../lib/KNoTCrypt.nc"
inline static uint8_t ControllerC__KNoT__controller_cack_handler(ChanState *state, DataPayload *dp){
#line 22
  unsigned char __nesc_result;
#line 22

#line 22
  __nesc_result = KNoTCryptP__KNoT__controller_cack_handler(state, dp);
#line 22
...
#line 22
# 125 "../lib/KNoTCryptP.nc"
static inline int KNoTCryptP__KNoT__valid_seqno(ChanState *state, DataPayload *dp)
#line 125
{
  if (state->seqno > __nesc_ntoh_uint8(dp->hdr.seqno.nxdata)) {
      return 0;
    }
  else 
#line 128
    {
      state->seqno = __nesc_ntoh_uint8(dp->hdr.seqno.nxdata);
      if (state->seqno >= 255) {
          state->seqno = 0;
        }
      return 1;
...
# 4 "../lib/KNoTCrypt.nc"
inline static int ControllerC__KNoT__valid_seqno(ChanState *state, DataPayload *dp){
#line 4
  int __nesc_result;
#line 4

#line 4
  __nesc_result = KNoTCryptP__KNoT__valid_seqno(state, dp);
#line 4
...
# 16 "../lib/KNoTCrypt.nc"
inline static void ControllerC__KNoT__qack_handler(ChanState *state, DataPayload *dp, uint8_t src){
#line 16
  KNoTCryptP__KNoT__qack_handler(state, dp, src);
#line 16
}
#line 16
# 91 "ControllerC.nc"
...
#line 91
{
  ...
  uint8_t cmd = __nesc_ntoh_uint8(dp->hdr.cmd.nxdata);

#line 96
  printf("CON>> Received packet from Thing: %d\n", src);
  printf("CON>> Received a %s command\n", cmdnames[cmd]);
  printf("CON>> Message for channel %d\n", __nesc_ntoh_uint8(dp->hdr.dst_chan_num.nxdata));
  printfflush();

  switch (cmd) {
      case 1: printf("NOT FOR US\n");
#line 102
      printfflush();
#line 102
      return msg;
      case 3: return msg;
      case 2: ControllerC__KNoT__qack_handler(&ControllerC__home_chan, dp, src);
#line 104
      return msg;
      case 8: return msg;
    }

  state = ControllerC__ChannelTable__get_channel_state(__nesc_ntoh_uint8(dp->hdr.dst_chan_num.nxdata));
  if (!state) {
      printf("Channel %d doesn't exist\n", __nesc_ntoh_uint8(dp->hdr.dst_chan_num.nxdata));
      state = &ControllerC__home_chan;
      state->remote_chan_num = __nesc_ntoh_uint8(dp->hdr.src_chan_num.nxdata);
      state->remote_addr = src;
      state->seqno = __nesc_ntoh_uint8(dp->hdr.seqno.nxdata);
      ControllerC__KNoT__close_graceful(state);
...
#line 117
    if (!ControllerC__KNoT__valid_seqno(state, dp)) {
        printf("Old packet\n");
        return msg;
      }
    }
#line 121
  switch (cmd) {
      case 4: ControllerC__KNoT__controller_cack_handler(state, dp);
#line 122
      break;
      case 16: ControllerC__KNoT__response_handler(state, dp);
#line 123
      break;
      case 5: ControllerC__KNoT__response_handler(state, dp);
#line 124
      ControllerC__KNoT__send_rack(state);
#line 124
      break;

      case 11: ControllerC__KNoT__ping_handler(state, dp);
#line 126
      break;
      case 12: ControllerC__KNoT__pack_handler(state, dp);
#line 127
      break;
      case 7: ControllerC__KNoT__disconnect_handler(state, dp);
      ControllerC__ChannelTable__remove_channel(state->chan_num);
#line 129
      break;
      default: printf("Unknown CMD type\n");
    }
  ControllerC__LEDBlink__report_received();
  return msg;
}

# 48 "../lib/KNoTCrypt.nc"
inline static message_t *KNoTCryptP__KNoT__receive(uint8_t src, message_t *msg, void *payload, uint8_t len){
#line 48
  nx_struct message_t *__nesc_result;
#line 48

#line 48
  __nesc_result = ControllerC__KNoT__receive(src, msg, payload, len);
#line 48
...
#line 48
# 422 "../lib/KNoTCryptP.nc"
static inline message_t *KNoTCryptP__Receive__receive(message_t *msg, void *payload, uint8_t len)
#line 422
{
  return KNoTCryptP__KNoT__receive(KNoTCryptP__AMPacket__source(msg), msg, payload, len);
}
...
# 78 "/home/user/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x412d99d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x412d99d0) {
#line 78
    case 10:
#line 78
      __nesc_result = KNoTCryptP__Receive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x412d99d0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 102 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40ea8520){
#line 102
  switch (arg_0x40ea8520) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40ea8520);
#line 102
      break;
#line 102
    }
...
# 102 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x40b5be78){
#line 102
  switch (arg_0x40b5be78) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x40b5be78);
#line 102
      break;
#line 102
    }
...
# 82 "/home/user/tinyos-main/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40ea6148, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0x40ea6148) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40ea6148, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 81 "/home/user/tinyos-main/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x412d6148, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x412d6148, msg);
#line 81
}
#line 81
...
# 102 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40e465b8){
#line 102
  switch (arg_0x40e465b8) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0x40e465b8);
#line 102
      break;
#line 102
    }
...
#line 100
# 110 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x412d9010, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x412d9010, msg, error);
#line 110
}
#line 110
# 120 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
...
#line 138
  KNoTCryptP__RadioControl__stopDone(error);
#line 138
}
#line 138
...
# 4 "../lib/BlockCipher.nc"
inline static error_t OCBModeP__cipher__encrypt(CipherContext *context, uint8_t *plainBlock, uint8_t *cipherBlock){
#line 4
  unsigned char __nesc_result;
#line 4

#line 4
  __nesc_result = SkipJackM__BlockCipher__encrypt(context, plainBlock, cipherBlock);
#line 4
...
blockSize, uint8_t keySize, uint8_t *key)
{
  ...
  if (((blockSize != 8 || keySize != 10) || context == (void *)0) || key == (void *)0) {
      return FAIL;
    }
#line 209
  for (i = 0; i < 38; i++) {
...
# 2 "../lib/BlockCipher.nc"
inline static error_t OCBModeP__cipher__init(CipherContext *context, uint8_t blockSize, uint8_t keySize, uint8_t *key){
#line 2
  unsigned char __nesc_result;
#line 2

#line 2
  __nesc_result = SkipJackM__BlockCipher__init(context, blockSize, keySize, key);
#line 2
...
#line 63
  ...
  uint8_t tmp[8] = { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 };

  uint8_t tmpP[8] = { 0xab, 0x98, 0x15, 0x30, 0x40, 0x91, 0x67, 0x85 };
  uint8_t tmpC[8] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

  OCBModeP__cipher__init(& context->cc, 8, keySize, key);
  OCBModeP__cipher__encrypt(& context->cc, tmp, tmp);


  OCBModeP__cipher__encrypt(& context->cc, tmpP, tmpC);
  OCBModeP__dumpBuffer("test1 ciphertxt initialized to 0, tmpP", tmpP, 8);
  OCBModeP__dumpBuffer("test1 tmpC", tmpC, 8);
  OCBModeP__cipher__encrypt(& context->cc, tmpP, tmpP);
  OCBModeP__dumpBuffer("test2", tmpP, 8);



  for (i = 0; i <= 7; i++) {
      OCBModeP__cpy_blk(OCBModeP__L[i], tmp, 8);
      first_bit = tmp[0] & 0x80u;
      OCBModeP__shift_left(tmp);
      if (first_bit) {
        tmp[8 - 1] ^= 0x1B;
        }
    }

  OCBModeP__cpy_blk(tmp, OCBModeP__L[0], 8);
  last_bit = tmp[8 - 1] & 0x01;
  OCBModeP__shift_right(tmp);
  if (last_bit) {
      tmp[0] ^= 0x80;
      tmp[8 - 1] ^= 0x0D;
    }

  OCBModeP__cpy_blk(OCBModeP__L_inv, tmp, 8);

  OCBModeP__preCombBlks = preCombBlocks;
...
# 70 "../lib/OCBMode.nc"
inline static error_t KNoTCryptP__CipherMode__init(CipherModeContext *context, uint8_t keySize, uint8_t *key, uint8_t tagLength, uint8_t preCombBlocks){
#line 70
  unsigned char __nesc_result;
#line 70

#line 70
  __nesc_result = OCBModeP__OCBMode__init(context, keySize, key, tagLength, preCombBlocks);
#line 70
...
inline static am_addr_t KNoTCryptP__AMPacket__address(void ){
#line 68
  unsigned int __nesc_result;
#line 68
...
#line 68
# 413 "../lib/KNoTCryptP.nc"
static inline void KNoTCryptP__RadioControl__startDone(error_t error)
#line 413
{
  printf("*********************\n*** RADIO BOOTED ****\n*********************\n");
  printf("RADIO>> ADDR: %d\n", KNoTCryptP__AMPacket__address());
  printfflush();
  KNoTCryptP__CipherMode__init(&KNoTCryptP__cc, KNoTCryptP__keySize, KNoTCryptP__key, KNoTCryptP__tagLength, KNoTCryptP__preCombBlocks);
}

# 113 "/home/user/tinyos-main/tos/interfaces/SplitControl.nc"
inline static void CC2420CsmaP__SplitControl__startDone(error_t error){
#line 113
  KNoTCryptP__RadioControl__startDone(error);
#line 113
}
#line 113
# 120 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
...
# 102 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x4092da98){
#line 102
  switch (arg_0x4092da98) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x4092da98);
#line 102
      break;
#line 102
    }
...
# 102 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40b5be78){
#line 102
  switch (arg_0x40b5be78) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40b5be78);
#line 102
      break;
#line 102
    }
...
# 59 "/home/user/tinyos-main/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40b7dcf8){
#line 59
  switch (arg_0x40b7dcf8) {
#line 59
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40b7dcf8);
#line 59
      break;
#line 59
    }
...
# 39 "/home/user/tinyos-main/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x40926a88){
#line 39
  union __nesc_unnamed4282 *__nesc_result;
#line 39

#line 39
  switch (arg_0x40926a88) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x40926a88);
#line 39
      break;
#line 39
    }
...
# 110 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x407df598, message_t * msg, error_t error){
#line 110
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x407df598, msg, error);
#line 110
}
#line 110
...
# 100 "/home/user/tinyos-main/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x4088bb58, message_t * msg, error_t error){
#line 100
  switch (arg_0x4088bb58) {
#line 100
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 100
...
#line 100
    default:
#line 100
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x4088bb58, msg, error);
#line 100
      break;
#line 100
    }
...
#line 45
  if (ChannelTableC__size >= 5) {
#line 45
    return (void *)0;
    }
#line 46
  temp = ChannelTableC__nextFree;
  temp->active = 1;
  ChannelTableC__nextFree = temp->nextChannel;
  ChannelTableC__size++;
  if (ChannelTableC__iterStart) {
      temp->nextChannel = ChannelTableC__iterStart;
      ChannelTableC__iterStart = temp;
    }
  return & temp->state;
}

# 12 "../lib/ChannelTable.nc"
inline static ChanState *ControllerC__ChannelTable__new_channel(void ){
#line 12
  struct channel_state *__nesc_result;
#line 12

#line 12
  __nesc_result = ChannelTableC__ChannelTable__new_channel();
#line 12
...
#line 204
  ...
  new_dp = & state->packet;
  memset(new_dp, '\0', sizeof(DataPayload ));
  KNoTCryptP__dp_complete(new_dp, state->chan_num, 0, 
  3, sizeof(ConnectMsg ));
  cm = (ConnectMsg *)new_dp->data;
  __nesc_hton_uint16(cm->rate.nxdata, rate);
  KNoTCryptP__KNoT__send_on_chan(state, new_dp);
  do {
#line 213
      state->ticks = 5;
...
# 18 "../lib/KNoTCrypt.nc"
inline static void ControllerC__KNoT__connect(ChanState *new_state, uint8_t addr, int rate){
#line 18
  KNoTCryptP__KNoT__connect(new_state, addr, rate);
#line 18
}
#line 18
# 142 "../lib/KNoTCryptP.nc"
static inline void KNoTCryptP__KNoT__knot_broadcast(ChanState *state, DataPayload *dp)
#line 142
{
  KNoTCryptP__increment_seq_no(state, dp);
  KNoTCryptP__send(AM_BROADCAST_ADDR, dp);
}
...
#line 154
  memset(new_dp, '\0', sizeof(DataPayload ));
  KNoTCryptP__dp_complete(new_dp, 0, 0, 
  1, sizeof(QueryMsg ));
  q = (QueryMsg *)new_dp->data;
  __nesc_hton_uint8(q->type.nxdata, type);
  strcpy((char *)q->name, "TEST");
  KNoTCryptP__KNoT__knot_broadcast(state, new_dp);
  do {
#line 161
      state->ticks = 5;
#line 161
...
# 12 "../lib/KNoTCrypt.nc"
inline static void ControllerC__KNoT__query(ChanState *state, uint8_t type){
#line 12
  KNoTCryptP__KNoT__query(state, type);
#line 12
}
#line 12
# 136 "ControllerC.nc"
...
#line 140
  ...
  printf("SERIAL> Packet length: %d\n", __nesc_ntoh_uint16(dp->dhdr.tlen.nxdata));
  printf("SERIAL> Message for channel %d\n", __nesc_ntoh_uint8(dp->hdr.dst_chan_num.nxdata));
  printf("SERIAL> Command code: %d\n", __nesc_ntoh_uint8(dp->hdr.cmd.nxdata));
  printfflush();

  switch (cmd) {
      case 1: ControllerC__KNoT__query(&ControllerC__home_chan, 1);
#line 149
      break;
      case 3: ControllerC__KNoT__connect(ControllerC__ChannelTable__new_channel(), __nesc_ntoh_uint8((
        (SerialConnect *)data)->addr.nxdata), __nesc_ntoh_uint8((
        (SerialConnect *)data)->rate.nxdata));
#line 152
      break;
    }
  ControllerC__LEDBlink__report_received();
...
# 78 "/home/user/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x407dd010, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x407dd010) {
#line 78
    case 10:
#line 78
      __nesc_result = ControllerC__SerialReceive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x407dd010, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/user/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x4088b518, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x4088b518) {
#line 78
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x4088b518, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 31 "/home/user/tinyos-main/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x4088a688, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x4088a688, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 65 "/home/user/tinyos-main/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40b7dcf8){
#line 65
  switch (arg_0x40b7dcf8) {
#line 65
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40b7dcf8);
#line 65
      break;
#line 65
    }
...
# 120 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x40926030){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x40926030) {
#line 120
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x40926030);
#line 120
      break;
#line 120
    }
...
# 128 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x40926030){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x40926030);
#line 128
      break;
#line 128
    }
...
# 61 "/home/user/tinyos-main/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40b58948){
#line 61
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40b58948);
#line 61
}
#line 61
# 93 "/home/user/tinyos-main/tos/system/ArbiterP.nc"
...
# 97 "/home/user/tinyos-main/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x40926030){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x40926030);
#line 97
      break;
#line 97
    }
...
# 109 "/home/user/tinyos-main/tos/lib/printf/PrintfP.nc"
static inline error_t PrintfP__Init__init(void )
#line 109
{
  /* atomic removed: atomic calls only */
...
# 64 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void ControllerC__CleanerTimer__startPeriodic(uint32_t dt){
#line 64
...
# 2 "../lib/ChannelState.nc"
inline static void ControllerC__ChannelState__init_state(ChanState *state, uint8_t chan_num){
#line 2
  ChannelStateC__ChannelState__init_state(state, chan_num);
#line 2
}
#line 2
# 27 "../lib/ChannelTableC.nc"
static inline void ChannelTableC__ChannelTable__init_table(void )
#line 27
{
  uint8_t i;
...
#line 29
  ChannelTableC__size = 0;
  ChannelTableC__nextFree = ChannelTableC__channelTable;
  for (i = 0; i < 5; i++) {
      ChannelTableC__channelTable[i].active = 0;
      ChannelTableC__channelTable[i].nextChannel = (struct knot_channel *)&ChannelTableC__channelTable[(i + 1) % 5];
      ChannelTableC__init_state(& ChannelTableC__channelTable[i].state, i + 1);
    }
  ChannelTableC__channelTable[5 - 1].nextChannel = (void *)0;
}

# 6 "../lib/ChannelTable.nc"
inline static void ControllerC__ChannelTable__init_table(void ){
#line 6
  ChannelTableC__ChannelTable__init_table();
#line 6
}
#line 6
# 2 "../lib/LEDBlink.nc"
inline static void ControllerC__LEDBlink__report_problem(void ){
#line 2
  LEDBlinkP__LEDBlink__report_problem();
#line 2
}
...
#line 77
{
  printf("\n*********************\n****** BOOTED *******\n*********************\n");
  printfflush();
  ControllerC__LEDBlink__report_problem();
  ControllerC__ChannelTable__init_table();
  ControllerC__ChannelState__init_state(&ControllerC__home_chan, 0);
  ControllerC__CleanerTimer__startPeriodic(100);
}
...
# 104 "/home/user/tinyos-main/tos/interfaces/SplitControl.nc"
inline static error_t KNoTCryptP__RadioControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 405 "../lib/KNoTCryptP.nc"
static inline void KNoTCryptP__Boot__booted(void )
#line 405
{
  if (KNoTCryptP__RadioControl__start() != SUCCESS) {
...
# 79 "/home/user/tinyos-main/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x40929c58, uint8_t byte){
#line 79
  switch (arg_0x40929c58) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x40929c58, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x40929c58, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x40929c58) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x40929c58, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/home/user/tinyos-main/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40b32010, uint8_t data){
#line 54
  switch (arg_0x40b32010) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40b32010, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x40929c58, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x40929c58) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x40929c58, buf, len, error);
#line 57
      break;
#line 57
    }
...
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40b32010){
#line 49
  switch (arg_0x40b32010) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40b32010);
#line 49
      break;
#line 49
    }
...
# 54 "/home/user/tinyos-main/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x40b32010, uint8_t data){
#line 54
  switch (arg_0x40b32010) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x40b32010, data);
#line 54
      break;
#line 54
    }
...
# 39 "/home/user/tinyos-main/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__fired(uint8_t arg_0x40b57010){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__default__fired(arg_0x40b57010);
#line 39
}
#line 39
...
# 49 "/home/user/tinyos-main/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x40b32010){
#line 49
  switch (arg_0x40b32010) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x40b32010);
#line 49
      break;
#line 49
    }
...
#line 49
# 61 "/home/user/tinyos-main/tos/system/QueueC.nc"
static inline uint8_t /*PrintfC.QueueC*/QueueC__0__Queue__maxSize(void )
#line 61
{
  return 250;
...
#line 58
# 152 "/home/user/tinyos-main/tos/lib/printf/PrintfP.nc"
static inline int PrintfP__Putchar__putchar(int c)
{
...
# 39 "/home/user/tinyos-main/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x40715b30){
#line 39
  switch (arg_0x40715b30) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x40715b30);
#line 39
      break;
#line 39
    }
...
#line 158
{
  if (error == SUCCESS) {
#line 159
    ControllerC__LEDBlink__report_sent();
    }
  else {
#line 160
    ControllerC__LEDBlink__report_problem();
    }
  ControllerC__serialSendBusy = FALSE;
}
...
{
#line 32
  LEDBlinkP__pulse_red_led(1000);
#line 32
  LEDBlinkP__pulse_blue_led(1000);
#line 32
  LEDBlinkP__pulse_green_led(1000);
}
...
# 142 "/home/user/tinyos-main/tos/lib/printf/PrintfP.nc"
static void PrintfP__AMSend__sendDone(message_t *msg, error_t error)
#line 142
{
  if (error == SUCCESS) {
...
# 426 "../lib/KNoTCryptP.nc"
static void KNoTCryptP__AMSend__sendDone(message_t *msg, error_t error)
#line 426
{
  if (error == SUCCESS) {
      KNoTCryptP__LEDBlink__report_sent();
      printf("RADIO>> Packet sent successfully\n");
    }
  else {
#line 430
    KNoTCryptP__LEDBlink__report_problem();
    }
#line 431
  KNoTCryptP__sendBusy = FALSE;
}
...
# 61 "../lib/ChannelTableC.nc"
static ChanState *ChannelTableC__ChannelTable__get_channel_state(int channel)
#line 61
{
  if (ChannelTableC__channelTable[channel - 1].active) {
      return & ChannelTableC__channelTable[channel - 1].state;
    }
  else {
#line 64
    return (void *)0;
...
#line 76
  ...
  __nesc_hton_uint8(dp->hdr.seqno.nxdata, state->seqno);
}

static void KNoTCryptP__send(int dest, DataPayload *dp)
#line 82
{
  uint8_t len = sizeof(PayloadHeader ) + sizeof(DataHeader ) + __nesc_ntoh_uint16(dp->dhdr.tlen.nxdata);
  DataPayload *payload = (DataPayload *)KNoTCryptP__AMSend__getPayload(&KNoTCryptP__am_pkt, sizeof(DataPayload ));

#line 85
  memcpy(payload, dp, sizeof(DataPayload ));

  if (KNoTCryptP__AMSend__send(dest, &KNoTCryptP__am_pkt, len) == SUCCESS) {
      KNoTCryptP__sendBusy = TRUE;
      printf("RADIO>> Sent a %s packet to Thing %d\n", cmdnames[__nesc_ntoh_uint8(dp->hdr.cmd.nxdata)], dest);
...
# 130 "/home/user/tinyos-main/tos/lib/printf/PrintfP.nc"
  int printfflush(void )
#line 130
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 117 "../lib/KNoTCryptP.nc"
static void KNoTCryptP__dp_complete(DataPayload *dp, uint8_t src, uint8_t dst, 
uint8_t cmd, uint8_t len)
#line 118
{
  __nesc_hton_uint8(dp->hdr.src_chan_num.nxdata, src);
  __nesc_hton_uint8(dp->hdr.dst_chan_num.nxdata, dst);
  __nesc_hton_uint8(dp->hdr.cmd.nxdata, cmd);
  __nesc_hton_uint16(dp->dhdr.tlen.nxdata, len);
}
...
# 70 "../lib/ChannelTableC.nc"
static void ChannelTableC__ChannelTable__remove_channel(int channel)
#line 70
{
  Channel *next;
  Channel *chan = &ChannelTableC__channelTable[channel - 1];

#line 73
  chan->nextChannel = ChannelTableC__nextFree;
  ChannelTableC__init_state(& chan->state, channel);
  chan->active = 0;
  ChannelTableC__nextFree = chan;
  ChannelTableC__size--;
  if (ChannelTableC__iterStart == chan) {
      ChannelTableC__iterStart = chan->nextChannel;
    }
  else 
#line 80
    {
      next = ChannelTableC__iterStart;
      while (next) {
...
#line 321
  if (state->state != 4 && state->state != 7) {
...
#line 274
        w3 = w2;
#line 274
        w2 = (bLeft = w1 >> 8, bRight = w1, bLeft ^= SkipJackM__F[bRight ^ skey[0]], bRight ^= SkipJackM__F[bLeft ^ skey[1]], bLeft ^= SkipJackM__F[bRight ^ skey[2]], bRight ^= SkipJackM__F[bLeft ^ skey[3]], (bLeft << 8) | bRight);
#line 274
        w1 = (w2 ^ tmp) ^ counter;
#line 274
        counter++;
...
#line 281
        w3 = (tmp ^ w2) ^ counter;
#line 281
        w2 = (bLeft = tmp >> 8, bRight = tmp, bLeft ^= SkipJackM__F[bRight ^ skey[0]], bRight ^= SkipJackM__F[bLeft ^ skey[1]], bLeft ^= SkipJackM__F[bRight ^ skey[2]], bRight ^= SkipJackM__F[bLeft ^ skey[3]], (bLeft << 8) | bRight);
#line 281
        counter++;
      }
#line 281
