...
interface MiniSec {
	...
	command error_t encrypt(CipherModeContext *cc, uint8_t *plain_blocks, uint8_t length, 
                              uint8_t *cipher_blocks, uint8_t *tag);
	command error_t decrypt(CipherModeContext *cc, uint8_t iv, uint8_t *cipher_blocks, uint8_t length, 
